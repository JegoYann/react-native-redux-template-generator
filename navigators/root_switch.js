...
import { NavigatorReduxListener } from '../utils/redux';

import { toJS } from '../utils/immutable_to_js';
import { AuthNav } from './auth_stack';
import { DrawerNav } from './nav_drawer';

export const Switch = SwitchNavigator(
    {
        auth: { screen: AuthNav },
...
class ReduxSwitch extends React.Component {
...
export default connect(mapStateToProps)(toJS(ReduxSwitch));
